...
public class RecipeNithing extends ShapedOreRecipe{

	public RecipeNithing() {
	...
	public ItemStack getCraftingResult(InventoryCrafting var1) {
		...
		if (var1.getStackInRowAndColumn(0, 1) != null 
			...
			nbt.setTag("head", var1.getStackInRowAndColumn(2, 0).writeToNBT(new NBTTagCompound()));
	...
	private static class Primer extends ShapedPrimer {
		public Primer() {
			...
			input.set(0, new OreIngredient("headHorse"));
